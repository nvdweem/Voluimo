...
void EarTrumpet::Interop::InitializeCOM()
{
	HRESULT hr = CoInitializeEx(NULL, COINIT_MULTITHREADED);
	if (hr != S_OK)
	{
		printf("Unable to initialize COM %i\n", hr);
	}
}

void EarTrumpet::Interop::DeInitializeCOM()
{
	CoUninitialize();
}
...
HRESULT AudioDeviceService::GetAudioDevices(std::vector<EarTrumpetAudioDevice>& out)
{
	out = _devices;
	return S_OK;
}
